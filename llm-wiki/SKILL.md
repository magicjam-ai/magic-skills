...
参考脚本见 `scripts/lint.sh`（相对本 skill 目录）。调用方式：

```bash
bash ~/.claude/skills/llm-wiki/scripts/lint.sh <wiki-root>
# 例：bash ~/.claude/skills/llm-wiki/scripts/lint.sh docs/research-wiki
```
